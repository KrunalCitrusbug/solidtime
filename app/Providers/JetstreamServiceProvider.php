...
class JetstreamServiceProvider extends ServiceProvider
{
    ...
    protected function configurePermissions(): void
    {
        ...
        Jetstream::role(Role::Manager->value, 'Manager', [
            ...
            'invoices:view',
            'invoice-settings:view',
        ])->description('Managers can view organization-wide projects, time entries, reports, and clients for auditing, but cannot create or edit data.');

        Jetstream::role(Role::TeamLead->value, 'Team Lead', [
            'charts:view:own',
            'projects:view',
            'project-members:view',
            'tasks:view',
            ...
            'members:view',
            'reports:view',
        ])->description('Team leads can view time entries and reports for members on projects they are assigned to, but cannot create or edit data.');
